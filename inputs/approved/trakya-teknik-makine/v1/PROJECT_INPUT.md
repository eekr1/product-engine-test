...
updated_at: "2026-08-13T04:43:23+03:00"
approved_at: "2026-08-13T04:43:23+03:00"
approved_by: "user"
supersedes: ""
...
> [!IMPORTANT]
> Bu belge Product Engine'in dondurulmuş canonical approved project truth girdisidir. `approved_by: user` ile açık kullanıcı onayı taşımaktadır.
...
- DEC-05: Planning profile değerleri `delivery_profile: Prototype`, `implementation_planning: standard`, `design_planning: light` olarak onaylanmıştır.
...
- ASM-02: (Tamamlanabilir) İletişim eylemleri için ilk aşamada direct `tel:` and `mailto:` bağlantıları yeterlidir. Status: `active`.
...
- **Status:** `approved`
- **Approved At:** 2026-08-13T04:43:23+03:00
- **Approved By:** user
