...
updated_at: "2026-08-14T03:51:30+03:00"
approved_at: "2026-08-14T03:51:30+03:00"
approved_by: "user"
supersedes: ""
...
> [!IMPORTANT]
> Bu belge Product Engine'in canonical project truth girdisidir. Bu sürüm explicit user approval ile dondurulmuş immutable `approved` snapshot'tır.
...
- "Sanayi = otomatik klasik lacivert kurumsal şablon" gibi sektör klişelerinden kaçınılacaktır.
...
- **Status:** `approved`
- **Approved At:** 2026-08-14T03:51:30+03:00
- **Approved By:** user
...
- [x] Assumption'lar kaydedildi ve status'ları `confirmed`.
...
- [x] `approved_by: user` için onay kanıtı mevcut.
