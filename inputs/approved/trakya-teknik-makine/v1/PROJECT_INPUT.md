...
updated_at: "2026-08-11T20:54:00+03:00"
approved_at: "2026-08-11T20:54:00+03:00"
approved_by: "user"
supersedes: ""
...
> [!NOTE]
> Bu belge Product Engine'in canonical approved proje girdi belgesidir (`v1`).
> Kullanıcı tarafından açık onay (`explicit user approval`) verilmiş ve üretim sürecine kabul edilmiştir.
...
| **Hizmetler** | Yedek Parça Temini, Yerinde Teknik Destek, Bakım-Onarım | İnteraktif hizmet kartları, mikro-animasyonlar, modern layout |
...
- **[ASM-01]** Proje `project_type: web-app` ve `delivery_profile: Prototype` olarak kabul edilmiştir.
...
- **Onay Durumu (status):** `approved`
- **Onay Tarihi (approved_at):** 2026-08-11T20:54:00+03:00
- **Onaylayan (approved_by):** `user`
...
- [x] Kullanıcıdan explicit approval alındı
