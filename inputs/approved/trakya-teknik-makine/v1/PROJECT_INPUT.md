...
> [!IMPORTANT]
> Bu belge Product Engine'in canonical project truth girdisidir. `approved` durumu kullanıcının kanonik explicit onayı ile kesinleşmiştir.
...
|---|---|---|---|---|---|---|
| ASM-001 | primary_language | Türkçe (`tr`) | safe | Proje Türk firması ve Trakya bölgesindeki müşteriler için hazırlandığından birincil dil Türkçedir. | proje bağlamı | confirmed |
| ASM-002 | contact_cta_behavior | tel: ve mailto: bağlantıları | safe | Mobil ve masaüstü cihazlarda doğrudan arama/e-posta başlatma standardı. | endüstri standardı | confirmed |
...
|---|---|---|---|---|---|---|---|
| CON-001 | current_vs_desired | Mevcut SITE123 tasarımı | Yenilenmiş modern visual concept | Onaylanan hedef vizyon esas alındı | Eski tasarım otorite değildir; firma metinleri ve mevcut sitede yer alan beyanlar korunur. | evet | resolved |
...
- **Status:** `approved`
- **Approved At:** 2026-08-11T22:25:44+03:00
- **Approved By:** user
