...
approved_at: "2026-08-15T02:45:00+03:00"
approved_by: "user"
supersedes: ""
...
> [!IMPORTANT]
> Bu belge Product Engine'in canonical project truth girdisidir. Explicit user approval alınmış ve status `approved` olarak dondurulmuştur.
...
- Gerçek firma bilgileri (adres, telefon, yetkili servis durumu) aynen korunmalı; doğrulanmavmış iddia uydurulmamalı.
...
- **Birincil Kullanıcılar:** Trakya bölgesindeki sanayi tesisleri, makine kullanıcıları, bakım/onarım ve yedek parça temini arayan işletme mevkileri.
...
- **Status:** `approved`
- **Approved At:** `2026-08-15T02:45:00+03:00`
- **Approved By:** `user`
