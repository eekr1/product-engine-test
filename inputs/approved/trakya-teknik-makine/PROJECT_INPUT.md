...
> [!IMPORTANT]
> Bu belge Product Engine'in canonical project truth girdisidir. Canonical explicit user approval alınarak `approved` durumuna geçirilmiştir.
...
- `delivery_profile: Prototype`, `implementation_planning: standard`, `design_planning: light` profilleri dondurulmak üzere önerilmiş ve onaylanmıştır.
...
- **Status:** `approved`
- **Approved At:** 2026-08-12T02:32:21+03:00
- **Approved By:** user
