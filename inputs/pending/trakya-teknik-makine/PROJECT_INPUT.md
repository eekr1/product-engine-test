...
updated_at: "2026-08-15T01:17:25+03:00"
approved_at: ""
approved_by: ""
supersedes: ""
...
> `design_planning` için `none` profile yoktur. UI/UX applicable olduğu için `light` profili seçilmiştir.
...
- Delivery profile `Prototype`, implementation planning `standard`, design planning `light` önerilmektedir.
