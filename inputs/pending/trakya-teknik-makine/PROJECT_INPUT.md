...
- Proposed Site Architecture: 7 distinct pages (`PAGE-001` .. `PAGE-007`).
...
|---|---|---|---|---|---|---|
| ASM-001 | primary_language | Türkçe (`tr`) | safe | Firma adı, hizmet bölgesi (Trakya) ve hedef kitle Türkiye/Trakya odaklıdır. | proje bağlamı | pending_review |
| ASM-002 | design_direction | Antrasit/koyu teknik yüzeyler + amber/turuncu accent | bounded | Source dosyasında tercih edilen creative direction olarak belirtilmiştir; resmi brand fact değildir. | proje bağlamı (source section 13) | pending_review |
...
- [x] UI/UX applicable ise `design_planning` `standard` olarak kesinleşti/önerildi.
...
- [x] Corporate website distinct approved pages single-page section seti gibi modellenmedi.
