...
updated_at: "2026-08-13T04:24:14+03:00"
approved_at: ""
approved_by: ""
supersedes: ""
...
- **ASM-001:** `primary_language` = `tr` (Gerekçe: Proje hedef kitlesi Trakya bölgesi ve kaynak metinler Türkçe. Safe assumption.) | Durum: `pending_review`
- **ASM-002:** `project_type` = `landing-page` (Gerekçe: Tanıtım ve hizmet sunumu odaklı kurumsal web sitesi demo yapısı. Bounded assumption.) | Durum: `pending_review`
