...
updated_at: "2026-08-13T04:08:13+03:00"
approved_at: ""
approved_by: ""
supersedes: ""
...
> `design_planning` için `none` profile yoktur. UI/UX applicable projelerde canonical değerler `light | standard | full`'dür.
...
- Stack seçimi henüz un-resolved (stack-neutral) durumdadır. Demo hızlı çalışan, modüler ve temiz bir mimari sunmalıdır.
- Presentation katmanı ile veri erişim katmanı ayrılmalıdır.
...
- Kesin frontend kütüphanesi / framework veya Vanilla JS seçimi (Pending intake aşamasında stack-neutral tutulmuştur; Engine kararlarıyla kesinleşecektir).
...
- **Q-01:** Firmanın yüksek çözünürlüklü vektörel logosu veya resmi kurumsal renk kodları mevcut mudur?
- **Q-02:** Demo kapsamına WhatsApp hızlı hat butonu, iletişim formu veya harita eklenecek midir?
- **Q-03:** Frontend uygulaması Vanilla HTML/CSS/JS mi yoksa Vite + React / Next.js tabanlı mı geliştirilecektir?
