...
> [!IMPORTANT]
> Bu belge Product Engine'in canonical project truth girdisidir. `approved` durumundadır ve kullanıcının açık onayı (`approved_by: user`) ile kesinleşmiştir. Canonical approved snapshot: `inputs/approved/trakya-teknik-makine/v1/PROJECT_INPUT.md`.
