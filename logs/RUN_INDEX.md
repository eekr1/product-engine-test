...
|---|---|---|---|---|---|---|---|---|
| RUN-20260815-001 | trakya-teknik-makine | demo-frontend | Prototype / standard / light | Completed | PASS | 2026-08-15 | `outputs/demos/trakya-teknik-makine/versions/v0.2/` | Product Engine v0.2.0 initial run |
