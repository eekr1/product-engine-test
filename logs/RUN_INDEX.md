...
| Run ID | Project Slug | Package | Profile | Status | Validation | Date | Output Ref | Note |
|---|---|---|---|---|---|---|---|---|
| RUN-20260813-001 | trakya-teknik-makine | demo-frontend | Prototype | Completed | PASS | 2026-08-13 | outputs/demos/trakya-teknik-makine/versions/v0.1 | Trakya Teknik Makine kurumsal yenileme demo v0.2.0 run |
