...
|---|---|---|---|---|---|---|---|---|
| RUN-20260815-001 | trakya-teknik-makine | demo-frontend | Prototype (impl: standard, design: light) | Completed | CONDITIONAL PASS | 2026-08-15 | `outputs/demos/trakya-teknik-makine/versions/v0.2/` | Trakya Teknik Makine v0.2.0 Planning Profile & Wave Run |
