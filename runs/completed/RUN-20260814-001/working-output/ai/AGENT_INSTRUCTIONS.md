...
4. `ai/TECH_CONTEXT.md` (Mimari yapı, tech stack ve data/service boundary)
...
- **Doğrulanmış Gerçeklik**: Ajan, firmanın müşterileri, başarıları veya ürün kapasiteleri hakkında doğrulanmamış bilgi üretemez (`PR-02`).
