...
- **Normal State**: Tüm yüzeyler (Hero + Contact) duyarlı ve erişilebilir şekilde çalışır.
- **Responsive Coverage**: Mobil (`320px`), Tablet (`768px`) ve Desktop (`1440px`) ekranlarda kusursuz yerleşim.
