...
- **Tanım**: Trakya Teknik Makine'nin mevcut kurumsal web sitesini (SITE123 altyapılı), firmanın doğrulanmış hizmetlerini ve Disan Hidrolik Trakya yetkili servisi konumunu koruyarak, satış görüşmesinde potansiyel müşteriye gösterilebilecek modern, güven veren ve görsel olarak güçlü bir frontend demo ile yeniden tasarlamak.
...
- [PRODUCT_RULES.md](./PRODUCT_RULES.md) — Ürün davranış ve UX kuralları
- [TECH_CONTEXT.md](./TECH_CONTEXT.md) — Teknik mimari ve entegrasyon sınırları
- [DESIGN_RULES.md](../design/DESIGN_RULES.md) — Görsel dil ve UX ilkeleri
- [DECISIONS.md](./DECISIONS.md) — Detaylı mimari ve ürün kararları
