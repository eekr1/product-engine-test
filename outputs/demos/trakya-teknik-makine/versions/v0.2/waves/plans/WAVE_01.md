...
- [WAVE_00.md](file:///c:/Users/Enis/Desktop/Product%20Engine/outputs/demos/trakya-teknik-makine/versions/v0.2/waves/plans/WAVE_00.md)
...
- [ ] **Task 01-04 (Services Grid)**: `CompanyService` katmanından çekilen 3 ana hizmet verisini (Bakım/Onarım, Yedek Parça, Yerinde Destek) [DESIGN_RULES.md](file:///c:/Users/Enis/Desktop/Product%20Engine/outputs/demos/trakya-teknik-makine/versions/v0.2/design/DESIGN_RULES.md) kart yapısıyla monte et.
...
- `WAVE_01` tamamlandığında [CURRENT_STATUS.md](file:///c:/Users/Enis/Desktop/Product%20Engine/outputs/demos/trakya-teknik-makine/versions/v0.2/ai/CURRENT_STATUS.md) belgesini güncelle ve run kapanışını raporla.
