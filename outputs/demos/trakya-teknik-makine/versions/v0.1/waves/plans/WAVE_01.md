...
- [ ] **Task 01.1 — Router Configuration**:
...
- [ ] **Task 01.2 — Desktop & Mobile Header Component**:
...
- [ ] **Task 01.3 — Global Footer Component**:
...
- [ ] 7 sayfanın tamamı navigasyondan erişilebilir.
- [ ] Anchor collapse yapılmamıştır.
