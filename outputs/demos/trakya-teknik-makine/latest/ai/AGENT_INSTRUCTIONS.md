...
7. `waves/WAVE_MAP.md` (Dalga haritası ve bağımlılık zinciri)
...
11. `ai/AGENT_INSTRUCTIONS.md` (Ajan çalışma standartları)
12. `ai/DECISIONS.md` (Dondurulmuş mimari ve ürün kararları)
