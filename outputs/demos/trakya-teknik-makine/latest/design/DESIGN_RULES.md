...
- **Monospace / Technical Accent**: İletişim numaraları, teknik yetkili servis kodları ve kart etiketlerinde kullanılan teknik alan fontu (`JetBrains Mono` veya `Roboto Mono`).
