...
- [ ] **Task 00-01 (Setup & Base Styles)**: [DESIGN_RULES.md](file:///c:/Users/Enis/Desktop/Product%20Engine/outputs/demos/trakya-teknik-makine/latest/design/DESIGN_RULES.md) standartlarına uygun CSS renk değişkenleri (`--primary-slate`, `--accent-amber`, `--surface-gray`) ve tipografi kurallarını `styles/main.css` dosyasına tanımla.
...
- `WAVE_00` tamamlandığında [CURRENT_STATUS.md](file:///c:/Users/Enis/Desktop/Product%20Engine/outputs/demos/trakya-teknik-makine/latest/ai/CURRENT_STATUS.md) belgesini güncelle ve `WAVE_01` planına geç.
