...
- Backend ve veritabanı zorunluluğu.
...
- Mevcut sitenin tasarımı kopyalanmamalı; firma bilgileri korunarak yeni bir görsel sistem kurulmalı.
- Hizmetler güçlü görsel hiyerarşiyle sunulmalı.
- Masaüstü ve mobil deneyim birlikte düşünülmeli.
- Gereksiz animasyon veya aşırı yaratıcı görsel dil yerine kurumsal güven ve satış etkisi öncelikli olmalı.
...
- Product Engine mevcut authority/read-order, intake, package/document selection ve approval contract'larını aynen uygulamalıdır.
- Demo odaklılık, gereksiz production complexity eklememek için önemli bir karar girdisidir.
